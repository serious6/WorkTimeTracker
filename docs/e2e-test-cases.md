...
| 8  | `tracks time with the timer and updates the metrics` | A project exists and is selected | The user starts and stops the timer | "Timer started" and "Timer stopped" appear and the button changes accordingly |
