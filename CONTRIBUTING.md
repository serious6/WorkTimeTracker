...
- `drizzle/0000_init.sql` is the baseline migration for a fresh database. Schema changes keep it in
  sync and add an idempotent migration that upgrades existing databases, together with
